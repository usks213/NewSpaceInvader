...
#define SCREEN_WIDTH	(224 * 4)				// ウインドウの幅
#define SCREEN_HEIGHT	(260 * 4)				// ウインドウの高さ

#define SCREEN_CENTER_X	(SCREEN_WIDTH/2)	// ウインドウの中心Ｘ座標
#define SCREEN_CENTER_Y	(SCREEN_HEIGHT/2)	// ウインドウの中心Ｙ座標

#define SCREEN_SCALE_X (SCREEN_WIDTH  / 224.0f)
#define SCREEN_SCALE_Y (SCREEN_HEIGHT / 260.0f)
